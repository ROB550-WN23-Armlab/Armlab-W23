...
try:
    _encoding = QtGui.Qplication.UnicodeUTF8
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # self.ThreshFrame = QtGui.QFrame(self.centralwidget)
        # self.ThreshFrame.setEnabled(True)
        # self.ThreshFrame.setFrameShape(QtGui.QFrame.StyledPanel)
        # self.ThreshFrame.setFrameShadow(QtGui.QFrame.Raised)
        # self.ThreshFrame.setLineWidth(1)
        # self.ThreshFrame.setObjectName(_fromUtf8("ThreshFrame"))
        ...
        self.TopThreshLabel = QtGui.QLabel(self.centralwidget)
        self.TopThreshLabel.setObjectName(_fromUtf8("TopThreshLabel"))
        # self.verticalLayout_7.addWidget(self.TopThreshLabel)
        self.sldrTopThresh = QtGui.QSlider(self.centralwidget)
        # self.sldrTopThresh.setMaximum(1000)
        # self.sldrTopThresh.setMinimum(925)
        # self.sldrTopThresh.setProperty("value", 950)
        # self.sldrTopThresh.setSliderPosition(950)
        self.sldrTopThresh.setMaximum(100)
        self.sldrTopThresh.setMinimum(0)
        self.sldrTopThresh.setProperty("value", 50)
        self.sldrTopThresh.setSliderPosition(50)
        
        self.sldrTopThresh.setOrientation(QtCore.Qt.Vertical)
        self.sldrTopThresh.setObjectName(_fromUtf8("sldrTopThresh"))
        # self.verticalLayout_7.addWidget(self.sldrTopThresh)
        self.rdoutTopThresh = QtGui.QLabel(self.centralwidget)
        self.rdoutTopThresh.setObjectName(_fromUtf8("rdoutTopThresh"))
        # self.verticalLayout_7.addWidget(self.rdoutTopThresh)

        self.BottomThreshLabel = QtGui.QLabel(self.centralwidget)
        self.BottomThreshLabel.setObjectName(_fromUtf8("BottomThreshLabel"))
        self.sldrBottomThresh = QtGui.QSlider(self.centralwidget)
        self.sldrBottomThresh.setMaximum(100)
        self.sldrBottomThresh.setMinimum(-50)
        self.sldrBottomThresh.setProperty("value", 0)
        self.sldrBottomThresh.setSliderPosition(0)


        self.sldrBottomThresh.setOrientation(QtCore.Qt.Vertical)
        self.sldrBottomThresh.setObjectName(_fromUtf8("sldrBottomThresh"))
        self.rdoutBottomThresh = QtGui.QLabel(self.centralwidget)
        self.rdoutBottomThresh.setObjectName(_fromUtf8("rdoutBottomThresh"))
        ...
        self.verticalLayout_11.addWidget(self.TopThreshLabel)
        self.verticalLayout_11.addWidget(self.sldrTopThresh)
        self.verticalLayout_11.addWidget(self.rdoutTopThresh)
        self.verticalLayout_11.addWidget(self.BottomThreshLabel)
        self.verticalLayout_11.addWidget(self.sldrBottomThresh)
        self.verticalLayout_11.addWidget(self.rdoutBottomThresh)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioUsr1.setText(_translate("MainWindow", "AprilTags", None))
        self.radioUsr2.setText(_translate("MainWindow", "Verify Rectification", None))
        ...
        self.TopThreshLabel.setText(_translate("MainWindow","TopThresh",None))
        self.rdoutTopThresh.setText(_translate("MainWindow","50",None))
        self.BottomThreshLabel.setText(_translate("MainWindow","BottomThresh",None))
        self.rdoutBottomThresh.setText(_translate("MainWindow","0",None))
